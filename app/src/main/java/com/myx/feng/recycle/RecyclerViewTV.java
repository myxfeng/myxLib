...
import com.myx.feng.recycle.impl.PrvInterface;
...
//        return cannotScrollBackward(value) || cannotScrollForward(value);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (!isHorizontalLayoutManger() && keyCode == KeyEvent.KEYCODE_DPAD_DOWN) {
            ...
            boolean f = false;
            if (onkeyLeftListener != null) {
                f = onkeyLeftListener.onKeyLeft(event);
            }
            if (f) {
                return true;
            }
        ...
        Log.i("TTTTT", "isLoading=" + isLoading);
        return super.dispatchKeyEvent(event);
    }

    public void setOnkeyLeftListener(OnkeyLeftListener onkeyLeftListener) {
        this.onkeyLeftListener = onkeyLeftListener;
    }

    OnkeyLeftListener onkeyLeftListener;

    public interface OnkeyLeftListener {
        boolean onKeyLeft(KeyEvent event);
...
//                        " lastComVisiPos: " + lastComVisiPos);
    ...
    public void setDefaultSelect(int pos) {
        RecyclerView.ViewHolder vh = findViewHolderForAdapterPosition(pos);
